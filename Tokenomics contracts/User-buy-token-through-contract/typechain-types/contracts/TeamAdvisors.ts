...
export interface TeamAdvisorsInterface extends utils.Interface {
  functions: {
    ...
    "teamadvisors(uint256)": FunctionFragment;
...
export interface TeamAdvisors extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TeamAdvisorsInterface;
  ...
  functions: {
    ...
    endTime(
      teamAdviId: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
