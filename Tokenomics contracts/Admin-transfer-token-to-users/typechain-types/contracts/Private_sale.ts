...
export interface Private_saleInterface extends utils.Interface {
  functions: {
    ...
    "saletypes(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "saletypes", data: BytesLike): Result;
...
export interface Private_sale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Private_saleInterface;
